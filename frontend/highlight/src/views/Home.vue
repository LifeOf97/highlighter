...
<!-- eslint-disable max-len -->
  <div id="home" class="mt-16 w-full h-full md:h-screen bg-white dark:bg-blueGray-800 overflow-x-hidden py-4 flex flex-col">
    <!-- start of div 1, which holds the page main view -->
    ...
    <!-- end of div 1, which holds the page main view -->
    <!-- start of div 2, which holds just the footer -->
    <div class="flex-1 flex justify-center items-center">
      <base-footer />
    </div>
    <!-- end of div 2, which holds just the footer -->
  </div>
</template>
